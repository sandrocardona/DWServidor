...
<body>
    <?php
    if(isset($conexion)){
        $consulta="select asignaturas.denominacion, notas.notas, notas.cod_asig from asignaturas, notas where asignaturas.cod_asig = notas.cod_asig and cod_alu = ".$_SESSION["id_alumno"]."";
